...
export const BAGISTO_GRAPHQL_PROXY = "/api/graphql";
 ...
 * cookies constant
 */
export const BAGISTO_SESSION = import.meta.env.VITE_BAGISTO_SESSION ?? "bagisto_session";
export const TOKEN = "token";
export const BASE_URL =
  typeof window !== "undefined" ? window.location.origin : "http://localhost:3001";
const bagistoEndpoint = (import.meta.env.VITE_BAGISTO_ENDPOINT ?? "http://localhost:8000").replace(
  /\/$/,
  "",
);
export const baseUrl = bagistoEndpoint;
export const GRAPHQL_URL = `${bagistoEndpoint}/graphql`;
export const STOREFRONT_KEY = import.meta.env.VITE_BAGISTO_STOREFRONT_KEY ?? "";
